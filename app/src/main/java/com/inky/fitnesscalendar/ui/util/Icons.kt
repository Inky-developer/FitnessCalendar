...
object Icons {
    ...
    val FilterOn = Icon(R.drawable.outline_filter_list_24)
    val FilterOff = Icon(R.drawable.outline_filter_list_off_24)
    ...
    val ResetImage = Icon(R.drawable.reset_image_24px)
